    ...
    return (
        <div className="flex flex-col gap-2 px-2.5 py-3 min-w-0">
            ...
            <div className='flex items-center justify-between'>
                ...
                <Link to={`/inventory/edit/${id}`} className="flex items-center gap-2 bg-(--color-primary) text-white px-4 py-2 rounded-sm text-sm font-semibold hover:bg-[#0e8a1d]">
            ...
            <div className=" bg-white p-3 rounded-sm border border-gray-200">
                <div className="flex gap-2 overflow-x-auto ">
                    {[1, 2, 3].map((i) => (
                        <div key={i} className={`w-30 h-30 rounded-sm border-2 shrink-0 bg-white flex items-center justify-center ${i === 1 ? 'border-purple-300 ring-2 ring-purple-100' : 'border-gray-200'}`}>
            ...
            <div className=" bg-white p-3 rounded-sm ">
                <div>
                    <h3 className="text-black font-bold text-sm mb-2">General Information</h3>
                    <hr className="border-gray-400 mb-3" />
                    <div className="bg-white rounded-sm border border-[#DDDDDD] p-2">
                        <h4 className="font-bold text-sm text-black underline mb-2">Description</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
                    <div className="bg-white border border-[#DDDDDD] rounded-sm p-3">
                        ...
                        <span className="text-sm text-black font-light">{product.priceUnit}</span>
                    </div>
                    <div className="bg-white border border-[#DDDDDD] rounded-sm p-3">
                        <label className="block text-xs font-bold text-[#212121] underline mb-1">THC/CBD/CBN Unit</label>
                        <span className="text-sm text-black font-light">{product.thcUnit}</span>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mt-2 mb-2">
                    <div className="bg-white border border-[#DDDDDD] rounded-sm p-3">
                        ...
                        <span className="text-sm text-black font-light">{product.thc}</span>
                    </div>
                    <div className="bg-white border border-[#DDDDDD] rounded-sm p-3">
                        <label className="block text-xs font-bold text-[#212121] underline mb-1">CBD MG</label>
                        <span className="text-sm text-blackfont-light">{product.cbd}</span>
                    </div>
                    <div className="bg-white border border-[#DDDDDD] rounded-sm p-3">
                        <label className="block text-xs font-bold text-[#212121] underline mb-1">CBN MG</label>
                        <span className="text-sm text-black font-light">{product.cbn}</span>
                    </div>
                </div>

                {/* Inventory Evaluation Section */}
                <div className='mb-2'>
                    <h3 className="text-black font-bold text-sm mb-2">Inventory Evaluation</h3>
                    <hr className="border-gray-400 mb-3" />
                ...
                <div className='mb-2'>
                    <h3 className="text-black font-bold text-sm mb-2">Set Low Stock Alert</h3>
                ...
                <div className='mb-2'>
                    <h3 className="text-black font-bold text-sm mb-1">Available Stock</h3>
